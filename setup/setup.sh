...
readonly dnf_install=("install gnome-tweak-tool" "gnome-extensions-app" "cabextract lzip p7zip p7zip-plugins unrar" "vlc" "toolbox" "steam" "youtube-dl" "bat" "exa" "procs" "htop" "fd-find" )
